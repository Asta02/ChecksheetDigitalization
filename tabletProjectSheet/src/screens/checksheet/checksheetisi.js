...
const ChecksheetIsi = ({ navigation, route }) => {
    const { valueShift, valueWo, valueTglCheck, valueTglDelivery, lastInsertedID } = route.params;
    ...
    const formattedValueTglCheck = new Date(valueTglCheck).toLocaleDateString('en-GB', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
    });
    const formattedValueTglDelivery = new Date(valueTglDelivery).toLocaleDateString('en-GB', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
    });
    ...
    //otomatis isi value berdasarkan WO
    useEffect(() => {
        const fetchData = async () => {
            try {
                const responseItemNumber = await fetch(`http://10.19.101.166:3003/getItemNumber/${valueWo}`, {
                    method: 'GET',
                    headers: {
                ...
                if (dataItemNumber.length > 0) {
                    const itemNumber = dataItemNumber[0].item_number;
                    setItemNumber(itemNumber);

                    // Fetch Type Battery Value
                    const responseTypeBattery = await fetch(`http://10.19.101.166:3003/getTypeBattery/${itemNumber}`, {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json'
                        },
                    ...
                    if (!responseTypeBattery.ok) {
                        throw new Error('Network response was not ok');
                    }

                    const dataTypeBattery = await responseTypeBattery.json();

                    if (dataTypeBattery.length > 0) {
                        // Split the type_battery string by space and/or slash
                        const batteryParts = dataTypeBattery[0].type_battery.split(/[ /]/);
                        const typeBatteryValue = batteryParts[0];

                        setTypeBattery(dataTypeBattery[0].type_battery);
                        setCoverTypeBatteryS(typeBatteryValue);
                    } else {
                        console.warn('No Type Battery found.');
                    }


                    // Fetch No Dokumen PCB
                    const responseNoDokPCB = await fetch(`http://10.19.101.166:3003/getNoDokPCB/${itemNumber}`, {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json'
                        },
                    ...
                    if (!responseNoDokPCB.ok) {
                        throw new Error('Network response was not ok');
                    }

                    const dataNoDokPCB = await responseNoDokPCB.json();

                    if (dataNoDokPCB.length > 0) {
                        setNoDokPCB(dataNoDokPCB[0].no_dok_pcb);
                    } else {
                        setNoDokPCB('');
                        console.warn('No Document PCB found.');
                    }
                } else {
                    console.warn('No item numbers found.');
                }
            } catch (error) {
    ...
    //fetch sticker
    useEffect(() => {
        const fetchStickerMultipleValue = async () => {
            try {
                const response = await fetch('http://10.19.101.166:3003/getSticker', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    const [batteryInformationPosition, setBatteryInformationPosition] = useState(2);
    ...
    const [itemNumber, setItemNumber] = useState("Loading...");
    const [typeBattery, setTypeBattery] = useState("Loading...");
    const [noDokPCB, setNoDokPCB] = useState("Loading...");
    ...
    useEffect(() => {
        ...
        updatedValues.item_number = itemNumber;
        updatedValues.type_battery = typeBattery;
    ...
    }, [valueBrandBatteryA, valueNegaraTujuanA, valueCustomerA, noDokPCB, itemNumber, typeBattery, debouncedUpdateBatteryInfo]);
    ...
    useEffect(() => {
        setPackingPosition((prevPosition) => {
            ...
            } else if (jumlahBatteryPaletS === '' && jumlahBatteryPaletA === '' && !jumlahBatteryPaletAFirst) {
                newPosition--;
            ...
            } else if (kondisiSusunanBattery === '' && !kondisiSusunanBatteryFirst) {
                newPosition--;
            ...
            } else if (kondisiIkatan === '' && !kondisiIkatanFirst) {
                newPosition--;
            ...
            } else if (tampilanPallet === '' && !tampilanPalletFirst) {
                newPosition--;
            ...
            if (valueStyrophoreKartonTriplexSFirst) {
                if (valueStyrophoreKartonTriplexS !== null && valueStyrophoreKartonTriplexS !== '' && valueStyrophoreKartonTriplexS !== undefined &&
                    ...
                    (valueStyrophoreKartonTriplexA === null || valueStyrophoreKartonTriplexA === '' || valueStyrophoreKartonTriplexA === undefined) &&
                    !valueStyrophoreKartonTriplexSFirst) {
                    newPosition--;
            ...
            } else if (inspectionTag === '' && !inspectionTagFirst) {
                newPosition--;
            ...
            } else if (shipingMark === '' && !shipingMarkFirst) {
                newPosition--;
            ...
            } else if (labelProduksi === '' && !labelProduksiFirst) {
                newPosition--;
            ...
            } else if (plastikShrink === '' && !plastikShrinkFirst) {
                newPosition--;
            ...
            } else if (kesesuaianTag === '' && !kesesuaianTagFirst) {
                newPosition--;
        ...
        jumlahBatteryPaletS, jumlahBatteryPaletA, kondisiSusunanBattery, kondisiIkatan, valueTypePalletS, valueTypePalletA, tampilanPallet,
    ...
    const previousValuesRefCover = useRef({
        ...
        type_battery_standard: coverTypeBatteryS,
    ...
    useEffect(() => {
        ...
        if (coverTypeBatteryS !== previousValues.type_battery_standard) updatedValues.type_battery_standard = coverTypeBatteryS;
    ...
    useEffect(() => {
        setCoverPosition((prevPosition) => {
            ...
            } else if (tampilanTerminal === '' && !tampilanTerminalFirst) {
                newPosition--;
            ...
            } else if (kodeProduksi === '' && !kodeProduksiFirst) {
                newPosition--;
            ...
            } else if (tampilanCover === '' && !tampilanCoverFirst) {
                newPosition--;
            ...
            } else if (kodeFinishing === '' && !kodeFinishingFirst) {
                newPosition--;
            ...
            } else if (tampilanVentPlug === '' && !tampilanVentPlugFirst) {
                newPosition--;
            ...
            } else if (indicatorElectrolite === '' && !indicatorElectroliteFirst) {
                newPosition--;
            ...
            } else if (coverTypeBatteryS === '' && coverTypeBatteryA !== '' && !valueCoverTypeBatteryFirst) {
                newPosition--;
        ...
        valueWarnaCoverS, valueWarnaCoverA, tampilanTerminal, kodeProduksi, valueBrandMarkS, valueBrandMarkA, tampilanCover,
    ...
    useEffect(() => {
        setContainerPosition((prevPosition) => {
            ...
            } else if (upperLower === '' && !upperLowerFirst) {
                newPosition--;
            ...
            } else if (tampilanContainer === '' && !tampilanContainerFirst) {
                newPosition--;
        ...
        valueWarnaContainerS, valueWarnaContainerA, valueMarkBrandContainerS, valueMarkBrandContainerA, valueMarkTypeS, valueMarkTypeA,
    ...
    useEffect(() => {
        setMasterBoxPosition((prevPosition) => {
            ...
            } else if (tampilanKabo === '' && !tampilanKaboFirst) {
                newPosition--;
            ...
            } else if (valueMasterBoxStickerS.length === 0 && valueMasterBoxStickerA.length === 0 && (!valueMasterBoxStickerSFirst || !valueMasterBoxStickerAFirst)) {
                newPosition--;
            ...
            } else if (instructionManualSisiPendek === '' && !instructionManualSisiPendekFirst) {
                newPosition--;
            ...
            } else if (masterBoxStamp.length === 0 && (!masterBoxStampFirst)) {
                newPosition--;
    ...
    }, [catatan, debouncedHandleCatatan]);
                        ...
                        <View style={styles.leftBoxIsiChecksheet}>
                            ...
                            <View style={[styles.leftBoxTopIsiChecksheet, { height: isKeyboardOpen ? '24%' : '30%' }]}>
                                ...
                                <View style={[styles.detailChecksheetBoxTextContainer, { paddingBottom: 0 }]}>
                                    ...
                                    <Text style={styles.detailChecksheetBoxTextRight}>{valueWo}</Text>
                                </View>
                                <View style={[styles.detailChecksheetBoxTextContainer, { paddingBottom: 0 }]}>
                                    <Text style={styles.detailChecksheetBoxTextLeft}>Shift</Text>
                                    <Text style={styles.detailChecksheetBoxTextRight}>{valueShift}</Text>
                                </View>
                                <View style={[styles.detailChecksheetBoxTextContainer, { paddingBottom: 0, paddingTop: 0 }]}>
                                    ...
                                    <Text style={styles.detailChecksheetBoxTextRight}>{formattedValueTglCheck}</Text>
                                </View>
                                <View style={[styles.detailChecksheetBoxTextContainer, { paddingBottom: 0 }]}>
                                    <Text style={styles.detailChecksheetBoxTextLeft}>Tanggal Delivery</Text>
                                    <Text style={styles.detailChecksheetBoxTextRight}>{formattedValueTglDelivery}</Text>
                                </View>
                            </View>
